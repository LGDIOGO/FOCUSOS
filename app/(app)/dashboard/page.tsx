      ...
      <AnimatePresence>
        {isSelectionMode && (
          <motion.div
            ...
            className="fixed bottom-[calc(env(safe-area-inset-bottom)+88px)] lg:bottom-10 left-1/2 lg:left-[calc(50%+128px)] -translate-x-1/2 z-[10000] w-[calc(100vw-1.5rem)] md:w-auto max-w-4xl bg-[var(--bg-primary)]/90 backdrop-blur-3xl border border-[var(--border-subtle)] rounded-[32px] md:rounded-[40px] px-4 md:px-10 py-4 md:py-5 flex items-center justify-between md:justify-start gap-4 md:gap-10 shadow-2xl ring-1 ring-white/5"
          >
