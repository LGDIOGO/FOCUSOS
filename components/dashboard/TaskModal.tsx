  ...
  return (
    <div className="fixed inset-0 z-[10000] flex items-center justify-center p-6">
      ...
      <motion.div 
        ...
        className="relative w-full max-w-lg bg-[var(--bg-primary)] border border-[var(--border-subtle)] rounded-[40px] md:rounded-[48px] p-6 md:p-8 overflow-y-auto max-h-[90vh] shadow-2xl z-[10001]"
      >
        <div className="flex justify-between items-center mb-8">
          <h2 className="text-4xl font-black tracking-tightest text-[var(--text-primary)]">{taskToEdit ? 'Editar Rascunho' : 'Novo Rascunho'}</h2>
